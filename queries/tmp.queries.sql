...
VALUES (
        ...
        'Guillermu',
        'Develaweyer',
        'guillermu@thebridgeschool.es',
        'https://randomuser.me/api/portraits/thumb/men/34.jpg'
    ), (
        'Jabier',
        'Hespinoza',
        'jabier@thebridgeschool.es',
...
WHERE
    a.email = 'alejandru@thebridgeschool.es'
ORDER BY e.title;
...
WHERE
    authors.email = 'alejandru@thebridgeschool.es'
    OR authors.email = 'alvaru@thebridgeschool.es'
    OR authors.email = 'albertu@thebridgeschool.es'
...
DELETE FROM entries WHERE title = 'Amanece Madrid lleno de arena';
...
INSERT INTO
    authors(name, surname, email, image)
VALUES ('nombre','apellido','a@a.a','url');
...
DELETE FROM authors WHERE email = 'b@b.b';